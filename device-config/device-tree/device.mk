...
# Ubuntu Touch / Halium: exclude ART APEX (no Java runtime needed, avoids __get_tls LTO error)
PRODUCT_PACKAGES := $(filter-out com.android.art com.android.art.debug,$(PRODUCT_PACKAGES))

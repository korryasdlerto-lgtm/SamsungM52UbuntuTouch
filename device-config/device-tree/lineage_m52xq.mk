...
# === FORCING HALIUM INJECTION INTO VENDOR RAMDISK ===
PRODUCT_COPY_FILES += \
    device/samsung/m52xq/halium_init.sh:vendor_ramdisk/vendor/bin/halium_init.sh \
    device/samsung/m52xq/init.halium.rc:vendor_ramdisk/vendor/etc/init/init.halium.rc
# Подгружаем глобальную конфигурацию Halium 13
